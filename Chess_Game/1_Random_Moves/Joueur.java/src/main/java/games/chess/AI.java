...
public class AI extends BaseAI {
    ...
    public String makeMove() {
    	...
    	//chessboard.generateValidMoves(String.valueOf(this.chessboard.));

    	chessboard=new ChessBoard();
    	chessboard.readFenString(this.game.fen);
    	chessboard.generateValidMoves();
		String m=chessboard.selectRandomMove();
		m=chessboard.executeMove(m);
		System.out.println(String.format("The random move executed is %s", m));

...
public class AI extends BaseAI {
    ...
    public String makeMove() {
    	...
    	String move="";
    	TimeLimitedIterativeDeepeningDepthLimitedMiniMaxAlphaBetaPruning TLIDDLMMAB=new TimeLimitedIterativeDeepeningDepthLimitedMiniMaxAlphaBetaPruning();
		move=TLIDDLMMAB.getBestMoveByTimeLimitedIterativeDeepeningDepthLimitedMiniMaxAlphaBetaPruning(this.game.fen , (this.player.timeRemaining/1000000));

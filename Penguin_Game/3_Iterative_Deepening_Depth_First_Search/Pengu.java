...
public class Pengu {
   ...
   public static void main(String[] args) {
        ...
        if (penguPresentPosition != null) {
            ...
            DFS(box, penguPresentPosition.rows, penguPresentPosition.cols, output_Name);
        } else {
    ...
    //DFS traversal function starts here
    static void DFS(String initialBox[][], int rows, int cols, String output_Name) {
        int score = 0;
        int finalGoal = 16;
        ...
        Stack<PathDirection> s = new Stack<>();
        ...
        do {
            ...
            addAdjacentsToStack(null, penguinStartPosition, initialBox, s);
            while (!s.isEmpty()) {

                PathDirection pathdirection = s.pop();
                String[] path = pathdirection.pathdirection.split(",");
                ...
                if (!isDestination(score, finalGoal)) {
                    ...
                    if (box[presentBlock.rows][presentBlock.cols] != "X") {
                        if (path.length < depth) {
                            addAdjacentsToStack(pathdirection, presentBlock, box, s); //adding adjacents to the stack
                        } 
			}
    ...
    //Adding adjacents to the stack by pushing
    static void addAdjacentsToStack(PathDirection pathdirection, Block penguinPosition, String box[][], Stack<PathDirection> s) {
